...
let user
const getInactiveUsers = array  => array.filter(({isActive}) => user = !isActive);
...
// в параметрах метода фільтр треба за умовою задачі використати деструктуризацію ({isActive}) і тоді трошки поміняти умови.